                ...
                <div class="card-body">
                    ...
                    @else
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    {{-- <label for="qr-code" class="form-label">رمز الاستجابة السريعة</label> --}}
                                    {!! $user->twoFactorQrCodeSvg() !!} {{-- Display the QR code for the user to scan --}}
                                    {{-- {!!!!} is used to display the QR code --}}
                                </div>
                            </div>
                            <div class="col-md-6">
                                <h5>رمز الاسترداد</h5>
