...
<head>
  ...
  <!-- ثيم بني شفاف + RTL -->
  <link rel="stylesheet" href="{{ asset('dashboard/dist/css/custom-rtl-brown.css') }}">
  @stack('styles')
</head>
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="starter.html" class="nav-link">الرئيسية</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <a href="#" class="dropdown-item">
            <div class="media">
              <img src="{{ asset('dashboard/dist/img/user1-128x128.jpg') }}" alt="صورة المستخدم" class="img-size-50 mr-3 img-circle">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  أحمد محمد
                  <span class="float-right text-sm text-danger"><i class="fas fa-star"></i></span>
                </h3>
                <p class="text-sm">اتصل بي عندما تستطيع...</p>
          ...
          <a href="#" class="dropdown-item">
            <div class="media">
              <img src="{{ asset('dashboard/dist/img/user8-128x128.jpg') }}" alt="صورة المستخدم" class="img-size-50 img-circle mr-3">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  خالد العلي
          ...
          <a href="#" class="dropdown-item">
            <div class="media">
              <img src="{{ asset('dashboard/dist/img/user3-128x128.jpg') }}" alt="صورة المستخدم" class="img-size-50 img-circle mr-3">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  نورة السالم
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <span class="dropdown-header">15 إشعاراً</span>
          <div class="dropdown-divider"></div>
          <a href="#" class="dropdown-item">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <a href="starter.html" class="brand-link">
      <img src="{{ asset('dashboard/dist/img/AdminLTELogo.png') }}" alt="شعار لوحة التحكم" class="brand-image img-circle elevation-3" style="opacity: .8">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="starter.html">الرئيسية</a></li>
